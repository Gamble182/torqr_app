        ...
        >
          ...
          <Section style={{ padding: '28px' }}>
            ...
            >
              ...
              <Text style={{ margin: '0 0 2px', fontWeight: 600, color: '#1A1A1A', fontSize: '16px' }}>
                {appointmentDate}
              </Text>
              <Text style={{ margin: '0 0 12px', color: '#006600' }}>
                {appointmentTime}
              </Text>
              <Text
                style={{
          ...
          <Section style={{ backgroundColor: '#F7F7F7', borderTop: '1px solid #E0E0E0', padding: '14px 28px' }}>
            <Text style={{ color: '#9A9A9A', fontSize: '11px', margin: '0' }}>
              Automatisch versendet via torqr
            </Text>
          </Section>
        </Container>
      </Body>
