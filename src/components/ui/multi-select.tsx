    ...
    <div className={cn('relative', className)}>
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute top-full left-0 z-50 mt-1 w-full min-w-32 rounded-lg border border-border bg-popover p-1 shadow-md">
              ...
              {options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'relative flex w-full cursor-pointer items-center gap-2 rounded-md py-2 px-2 text-sm',
