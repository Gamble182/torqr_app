...
| Metrik | Wert |
|---|---|
| Echtzeit gesamt (deine Arbeit mit Claude) | **~86 h** (Teil 1: ~20 h · Teil 2: ~50 h · Teil 3: ~16 h) |
| Solo-Dev-Äquivalenz gesamt (Senior Full-Stack, ohne KI) | **~573 h** (Teil 1: 145 h · Teil 2: 312 h · Teil 3: 116 h) |
| Effizienzfaktor (Solo / Echtzeit) | **~6.7 ×** |
| MVP-Wert @ 95 €/h | **~54.435 €** |
