...
| Metrik | Wert |
|---|---|
| Echtzeit gesamt (deine Arbeit mit Claude) | **~88 h** (Teil 1: ~20 h · Teil 2: ~50 h · Teil 3: ~18 h) |
| Solo-Dev-Äquivalenz gesamt (Senior Full-Stack, ohne KI) | **~575 h** (Teil 1: 145 h · Teil 2: 312 h · Teil 3: 118 h) |
| Effizienzfaktor (Solo / Echtzeit) | **~6.5 ×** |
| MVP-Wert @ 95 €/h | **~54.625 €** |
