...
| Metrik | Wert |
|---|---|
| Echtzeit gesamt (deine Arbeit mit Claude) | **~92 h** (Teil 1: ~20 h · Teil 2: ~50 h · Teil 3: ~22 h) |
| Solo-Dev-Äquivalenz gesamt (Senior Full-Stack, ohne KI) | **~623.5 h** (Teil 1: 145 h · Teil 2: 312 h · Teil 3: 166.5 h) |
| Effizienzfaktor (Solo / Echtzeit) | **~6.8 ×** |
| MVP-Wert @ 95 €/h | **~59.233 €** |
